...
int cDataTransferCanRaw::addConnection(const cISocket::cConnectionParams *const connection_params)
{
    ...
    cCanConnectionParams *p_param =
            new (std::nothrow) cSocketCanRaw::cSocketCanRawParams;
    ...
    p_param->_can_interface_num =
            static_cast<const cCanConnectionParams *const>(connection_params)
            ->_can_interface_num;
...
bool cDataTransferCanRaw::write(const int connection_id,
...
int cDataTransferCanRaw::read(const int connection_id,
