...
const int AutoconStartCID = 0x3F;

class cDeviceConfig_Autocon : public cDeviceConfig  // Конфигуратор Дефектоскопа
{
public:
    cDeviceConfig_Autocon(cChannelsTable* tbl_, int AScanTh, int BScanTh);  // Конструктор
    ~cDeviceConfig_Autocon(void);                                           // Деструктор
