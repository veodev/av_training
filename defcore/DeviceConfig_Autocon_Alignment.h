...
const AutoconStartCID = 0x3F;

class cDeviceConfig_Autocon_Alignment : public cDeviceConfig  // Конфигуратор Дефектоскопа
{
public:
    cDeviceConfig_Autocon_Alignment(cChannelsTable* tbl_, int AScanTh, int BScanTh);  // Конструктор
    ~cDeviceConfig_Autocon_Alignment(void);                                           // Деструктор
                                                                                      /*
