#ifndef PROT_UMU_USBCANAND_H
#define PROT_UMU_USBCANAND_H

#include "datatransfers/datatransfer_usbcan_and.h"
#include "prot_umu_rawcan.h"

class UMU_USBCANAND : public CANProtDebug::UMU_RAWCAN
{
...
//
    void UnPack(const cMessageCan &buff);
...
public:
    // ------------------------- C-TORS and D-TORS -----------------------------
    UMU_USBCANAND();
    ~UMU_USBCANAND() { /*delete _out_block; _out_block = 0;*/ }

    eProtocol getProtocolType() const { return eProtUSBCANAND; }
};

#endif // PROT_UMU_USBCANAND_H
