...
//
void UMU_USBCAN::UnPack(cMessageCan buff)
{
...
//
UMU_USBCAN::UMU_USBCAN() : CANProtDebug::UMU_RAWCAN()
{
    _protocol = eProtUSBCAN;
    _bodySize = 0;
}
// 
void UMU_USBCAN::sendCommandWithData(const unsigned char command_id, const unsigned char *data, const unsigned char size)
{
...
//
bool UMU_USBCAN::parseResponse_BScanStopped(unsigned char *data, unsigned char size)
{
...
void UMU_USBCAN::SetMScanFormat(MScanFormat mScanVar)
{
